...
/** This component is for Slider section */
...
const Hero = ({handleOrderPopup}) => {
  ...
  // Initializing settings for slider
  ...
  return (
    <div className='container'>
      <div className='overflow-hidden rounded-3xl min-h-[550px] sm:min-h-[650px] hero-bg-color flex 
