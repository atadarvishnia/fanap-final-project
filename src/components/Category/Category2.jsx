...
/** This component is  Second line of categories under the slider. */
        ...
        <div className="container">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            text-white rounded-3xl relative h-[320px] flex items-end ">
              ...
              <img src={Image1} alt="earphone" className="w-[250px] absolute top-1/2 -translate-y-1/2
              -right-0"/>
            </div>
            {/* second col */}
            ...
            rounded-3xl relative h-[320px] flex items-start">
              ...
              <img src={Image3} alt="earphone" className="w-[200px] absolute right-4 bottom-0"/>
            </div>
